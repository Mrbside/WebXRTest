AFRAME.registerComponent("model-viewer", {
    schema: { gltfModel: { default: "" }, title: { default: "" }, uploadUIEnabled: { default: true } },
    init: function () {
        var el = this.el;
    ...
    initCameraRig: function () {
        ...
        cameraEl.setAttribute("look-controls", { magicWindowTrackingEnabled: false, mouseEnabled: false, touchEnabled: false });
    ...
    initBackground: function () {
        ...
        backgroundEl.setAttribute("material", { shader: "background-gradient", colorTop: "#37383c", colorBottom: "#757575", side: "back" });
    ...
    initEntities: function () {
        ...
        sceneLightEl.setAttribute("light", { type: "hemisphere", intensity: 1 });
